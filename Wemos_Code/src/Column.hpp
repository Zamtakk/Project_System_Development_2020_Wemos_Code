...
void handleMessage(JsonObject message)
{
    ...
    case DEVICEINFO:
    {
        ...
        deviceInfoMessage["buzzerState"] = output1State;
        deviceInfoMessage["gasSensorValue"] = analogInput0Value;
    ...
    case COLUMN_LED_CHANGE:
    {
        output0State = (bool)message["value"];
        break;
    }

    case COLUMN_BUZZER_CHANGE:
    {
...
void handleDigitalInput()
{
    ...
    if (input0State != input0State_Previous)
    {
        ...
        sendBoolMessage(COLUMN_BUTTON_CHANGE, input0State);
    }
}
...
void handleAnalogInput()
{
    ...
    if (abs(analog0In_avg - analog0In_Previous) > 8)
    {
        ...
        sendIntMessage(COLUMN_GASSENSOR_CHANGE, analogInput0Value);
    }
}
